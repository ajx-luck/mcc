...
public class RandomValidateCodeUtils {
    ...
    private static int height = 45;// 图片高
    ...
    public static void getRandcode(HttpServletRequest request, HttpServletResponse response) {
        ...
        g.setColor(getRandColor(random,110, 133));//字体颜色
        // 绘制干扰线
        ...
        for (int i = 1; i <= stringNum; i++) {
            randomString = drowString(random,g, randomString, i);
        }
     ...
     * 绘制字符串
     */
    private static String drowString(Random random,Graphics g, String randomString, int i) {
        g.setFont(getFont());
     ...
     * 绘制干扰线
     */
    private static void drowLine(Random random,Graphics g) {
